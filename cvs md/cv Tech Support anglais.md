<!-- CV Tech Support Anglais -->

# HEADER
Alexandre Balakirev  
Technicien Support / Développeur Web  
...
Technicien support avec une expérience en support applicatif N1/N2, diagnostic d'incidents et gestion de tickets. <br>
Anglais courant (C1), à l'aise pour échanger avec des utilisateurs et rédiger de la documentation technique. <br>
Autonome, rigoureux et orienté service.
...
- [fa:solid:magnifying-glass] Diagnostic & analyse d'incidents (logs, reproduction, investigation)
- [fa:solid:ticket] Outils de ticketing : Jira
- [fa:solid:database] SQL : requêtes, vérification & correction de données
- [fa:solid:code] Bases en développement : Java, PHP, Python
- [fa:solid:desktop] Environnements applicatifs : Windows, Linux, Bash
- [fa:solid:file-lines] Documentation technique & base de connaissances
...
- Correction de bugs, optimisation SQL
