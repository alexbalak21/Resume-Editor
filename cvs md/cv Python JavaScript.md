<!-- CV Développeur Full-stack Python / JavaScript -->
...
Développeur **Full-Stack Python / JavaScript**, spécialisé dans la création d'APIs REST, de services métier et d'applications web. <br>
Autonome, rigoureux et curieux, j'apprécie les environnements multi-technologies et les projets où la qualité du code et l'évolution continue sont essentielles.
...
- [fa:brands:js] JavaScript / TypeScript : Vue.js, React
