...
Développeur **Java / Spring Boot** et **JavaScript / TypeScript**, capable de concevoir, développer et livrer des applications complètes. <br>
...
- [fa:solid:server] **Dev Backend** : Python, Node, PHP
